...
<!-- Footer -->
    ...
    <script>
        function deleteItem(button) {
            // Remove the parent element of the button (which is the entire item row)
        ...
        function calculateGrandTotal() {
            ...
            document.querySelectorAll('.row.gy-3.mb-4').forEach(itemRow => {
                // Get the price per item and quantity
                const pricePerItem = parseFloat(itemRow.querySelector('.h6').innerText.replace('$', ''));
                const quantity = parseInt(itemRow.querySelector('.form-select').value);
                // Calculate the total price for the item row and add it to the grand total
